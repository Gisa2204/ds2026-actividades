...
const librosForm = document.querySelector("#libros-form") as HTMLFormElement;
const tituloInput = document.querySelector("#titulo-input") as HTMLInputElement;
const autorInput = document.querySelector("#autor-input") as HTMLInputElement;
const precioInput = document.querySelector("#precio-input") as HTMLInputElement;
const generoInput = document.querySelector("#genero-input") as HTMLInputElement;
const disponibleInput = document.querySelector("#disponible-input") as HTMLInputElement;
const errorFormDiv = document.querySelector("#errorForm-div") as HTMLDivElement;

const actualizarStats = (libros: Libro[]) => {
...
const renderizar = (libros: Libro[]): void => 
{
    ...
    for (const libro of libros) 
    {
        ...
        const libroli = document.createElement("li") as HTMLLIElement;
        ...
        const eliminarLibroBtn = document.createElement('button') as HTMLButtonElement;
        eliminarLibroBtn.textContent = 'ELIMINAR';
        eliminarLibroBtn.className = 'eliminar-btn';
        eliminarLibroBtn.addEventListener
        ('click', () => 
            {
...
const validarFormulario = (): Libro | null => 
{
    ...
    if (titulo === "") {
        const tituloError = document.createElement("p") as HTMLParagraphElement; 
    ...
    if (autor === "") {
        const autorError = document.createElement("p") as HTMLParagraphElement; 
    ...
    if (isNaN(precio) || precio <= 0) {
        const precioError = document.createElement("p") as HTMLParagraphElement; 
